...
export default function Spo2Chart({ title }) {
  const data = useSpo2Store((store) => store.waveValue)
  const newBarChartValue = useSpo2Store((store) => store.newBarChartValue)
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IndicatorIcon sx={{ color: '#00ff00' }} height={newBarChartValue} />
      </Box>
